...
public class ExtractData {
	...
	public static void main(String[] args) throws SQLException, FileNotFoundException, DocumentException {
		...
		Connection ct = DriverManager.getConnection("jdbc:mysql://localhost:3306/advjdb", "root", "Subha1234@");
		Statement st = ct.createStatement();
		ResultSet rs = st.executeQuery(sql);

		Document d = new Document();

		PdfWriter.getInstance(d, new FileOutputStream("C:\\Users\\dsubh\\OneDrive\\Desktop\\New folder\\data.pdf"));
